...
(function() {
    ...
    var addLegacyToolbarButton = function(window) {
        ...
        if ( styleSheetUri === null ) {
            ...
            styleSheetUri = Services.io.newURI(vAPI.getURL('styles/legacy-toolbar-button.css'), null, null);
...
(function() {
    ...
    tbb.init = function() {
        ...
        var style = [
            ...
            '#' + this.id + ' {',
                'list-style-image: url(',
                    // vAPI.getURL('images/browsericons/icon16.svg'),
...
vAPI.contextMenu = (function() {
    ...
    var onMenuShowing = function({target}) {
        ...
        if ( newMenuitems.length === 1 ) {
            ...
            menuitem.setAttribute('image', vAPI.getURL('images/browsericons/icon16.svg'));
        ...
        if ( menu === null ) {
            ...
            menu.setAttribute('image', vAPI.getURL('images/browsericons/icon16.svg'));
